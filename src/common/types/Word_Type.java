...
public class Word_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("common.types.Word");
  ...
  public String getLemma(int addr) {
      ...
      jcas.throwFeatMissing("lemma", "common.types.Word");
  ...
  public String getMph(int addr) {
      ...
      jcas.throwFeatMissing("mph", "common.types.Word");
  ...
  public String getPosTag(int addr) {
      ...
      jcas.throwFeatMissing("posTag", "common.types.Word");
  ...
  public String getChunkTag(int addr) {
      ...
      jcas.throwFeatMissing("chunkTag", "common.types.Word");
  ...
  public String getRaw(int addr) {
      ...
      jcas.throwFeatMissing("raw", "common.types.Word");
  ...
  public String getSubCat(int addr) {
      ...
      jcas.throwFeatMissing("subCat", "common.types.Word");
